...
export default function MorningPracticeApp() {
  ...
  const playMeditationBell = () => {
    ...
    gainNode.gain.linearRampToValueAtTime(0.3, audioContext.currentTime + 0.1); // Reduced volume for "weak" gong
  ...
  const speak = (text: string) => {
    ...
    const femaleVoice = voices.find(voice => 
      ...
      voice.lang.includes(window.navigator.language.split('-')[0])
    );
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 p-4">
      <div className="w-full bg-white rounded-2xl shadow-lg overflow-hidden sm:max-w-lg md:max-w-xl lg:max-w-2xl">
        {/* Header */}
        ...
        {/* Main content */}
        <div className="p-6 min-h-[550px] flex flex-col justify-between">
          {stage === STAGES.START && (
            // Start screen
              ...
              {!isTimerActive && (
                <div className="flex space-x-4 mb-4">
                  ...
                  <button 
                    onClick={() => {
                      if (currentExercise) {
                        speak(`${currentExercise.name}. ${currentExercise.description}`);
                      }
                    }}
